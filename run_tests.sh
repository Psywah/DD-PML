...
FreeFem++  HelmPMLDD.edp -ns -nw -lengthoverlaps $2 -lengthpml 0.025 -gmres 0 -apml 5000  -wavenumber 40 -npartx $1 -additive
FreeFem++  HelmPMLDD.edp -ns -nw -lengthoverlaps $2 -lengthpml 0.025 -gmres 1 -apml 5000  -wavenumber 40 -npartx $1 -additive
FreeFem++  HelmPMLDD.edp -ns -nw -lengthoverlaps $2 -lengthpml 0.025 -gmres 0 -apml 5000  -wavenumber 80 -npartx $1 -additive
FreeFem++  HelmPMLDD.edp -ns -nw -lengthoverlaps $2 -lengthpml 0.025 -gmres 1 -apml 5000  -wavenumber 80 -npartx $1 -additive
FreeFem++  HelmPMLDD.edp -ns -nw -lengthoverlaps $2 -lengthpml 0.025 -gmres 0 -apml 5000  -wavenumber 120 -npartx $1 -additive
FreeFem++  HelmPMLDD.edp -ns -nw -lengthoverlaps $2 -lengthpml 0.025 -gmres 1 -apml 5000  -wavenumber 120 -npartx $1 -additive
FreeFem++  HelmPMLDD.edp -ns -nw -lengthoverlaps $2 -lengthpml 0.025 -gmres 0 -apml 5000  -wavenumber 160 -npartx $1 -additive
FreeFem++  HelmPMLDD.edp -ns -nw -lengthoverlaps $2 -lengthpml 0.025 -gmres 1 -apml 5000  -wavenumber 160 -npartx $1 -additive


#echo "number of subdomain $1"
#echo "method $2" # -additive -sweep
